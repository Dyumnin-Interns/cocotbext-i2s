...
# These classes are added to resolve the ImportError in the testbench.
# They inherit from the base I2sDriver.

class I2sMaster(I2sDriver):
    """I2S Master Driver.

    This driver is responsible for generating the sclk and ws signals.
    """


class I2sSlave(I2sDriver):
    """I2S Slave Driver.

    This driver responds to the sclk and ws signals generated by a master.
    """
